...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NESting Demo Installer\n"
      else:
        line="OutputBaseFilename=NESting Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NESting Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NESting installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NESting Demo installer\n"
     else:
       line="SetupWindowTitle=NESting installer\n"
