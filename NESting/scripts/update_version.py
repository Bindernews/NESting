...
def main():
  ...
  plistpath = scriptpath + "/resources/NESting-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NESting-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NESting-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NESting-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NESting-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/NESting.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/NESting.iss",inplace=1):
